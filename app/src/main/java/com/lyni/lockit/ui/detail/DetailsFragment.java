...
public class DetailsFragment extends Fragment {
    ...
    private void setTextViewClickListener() {
        ...
        binding.detailsAccountNotes.setOnClickListener(v -> inputDialog.getInstance("备注", R.drawable.ic_notes_24, input -> {
    ...
    private void setLoginWayId() {
        switch (loginWay) {
            case 0:
                binding.loginWayInfoIcon.setImageResource(R.drawable.ic_phone_28);
                binding.loginWayInfoText.setText(account.getTele() == null ? "--" : account.getTele());
                break;
            case 1:
                binding.loginWayInfoIcon.setImageResource(R.drawable.ic_email_28);
